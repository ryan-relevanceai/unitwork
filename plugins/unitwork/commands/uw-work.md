...
See [checkpointing.md](../skills/unitwork/references/checkpointing.md) for the complete checkpointing protocol including:
- **Checkpoint Commit Format** - The standard commit message format
- **Verification Document** - Template at [templates/verify.md](../skills/unitwork/templates/verify.md)
...
**This step ONLY applies to fix checkpoints** (e.g., `checkpoint(2.1)`, `checkpoint(3.2)`). Skip this step for regular unit checkpoints.
