...
- **Repo list**: All arguments matching `owner/repo` pattern (e.g., `your-org/your-repo`)
...
**If no repos provided:** Ask the user: "Which repos should I harvest? Provide one or more in `owner/repo` format (e.g., `your-org/your-repo`)."
